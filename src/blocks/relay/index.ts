...
export {
  ensureConsumer, removeConsumer, removeUserConsumers, cleanupExpiredConsumers,
  scheduleConsumerCleanup, syncConsumersFromNats, getConsumerStats,
  getPendingMessages, getAllPendingMessages, getPendingCount,
} from './consumers.js';
